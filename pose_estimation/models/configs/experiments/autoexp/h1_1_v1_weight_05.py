"""H1.1: Soft v1_weight=0.5 for occluded keypoints.

Hypothesis: Reducing the loss weight of occluded (v=1) keypoints from 1.0 to 0.5
decreases noise from uncertain annotations without completely ignoring them.
Expected: OKS@75 improves over baseline (0.891).
"""
